  ...
  for (let j = 0; j < data.length; j++) {
    if (typeof data[j] !== "undefined") {
      ...
      li.innerHTML = data[j].name +
        " <button class=hp-character griffindor style=color:#FFD700;  onclick='toggle(" + j + ")'>Toggle</button> " +
        " <button class=hp-character griffindor   style=color:#A52A2A; onclick='deleteTask(" + j + ")'>Delete</button>";
      if (data[j].done === true) {
